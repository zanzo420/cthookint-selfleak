...
void Offsets::GetOffsets()
{
	...
	offsets.DT_BaseAnimating.m_flCycle = NetVarManager::GetOffset(tables, "DT_BaseAnimating", "m_flCycle");
	...
	offsets.DT_BaseAnimating.m_flPlaybackRate = NetVarManager::GetOffset(tables, "DT_BaseAnimating", "m_flPlaybackRate");
	...
	offsets.DT_BaseCombatWeapon.m_flPostponeFireReadyTime = NetVarManager::GetOffset(tables, "DT_BaseCombatWeapon", "m_flPostponeFireReadyTime");
	...
	offsets.DT_Ragdoll.m_ragPos = NetVarManager::GetOffset(tables, "DT_Ragdoll", "m_ragPos");
}
