...
typedef void(*SendClanTagFn) (const char* clantag, const char* teamname);
...
const std::map<ItemDefinitionIndex, DefItem_t> ItemDefinitionIndexMap = {
	...
	{ ItemDefinitionIndex::WEAPON_MP5,{ "#SFUI_WPNHUD_MP5SD", "weapon_mp7", "models/weapons/v_smg_mp5sd.mdl", "mp5sd" } },
