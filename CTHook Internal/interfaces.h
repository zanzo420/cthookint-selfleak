...
extern IViewRenderBeams*	pViewRenderBeams;
...
extern std::unique_ptr<VMTHook>pInputInternalHook;
extern std::unique_ptr<VMTHook>SceneEndHook;

extern HFont esp_font;
extern HFont esp_name_font;
extern HFont lby_font;
extern HFont freestanding_font;
extern HFont weapon_icon;
extern HFont weapon_icon_custom;
